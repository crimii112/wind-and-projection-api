...
GRID_CONFIG = {
    9: {
        "CONC": "CONC.09KM.2025063012.nc",
        "GRIDCRO": "GRIDCRO2D_09KM.2025063012.nc",
        "METDOT": "METDOT3D_09KM.2025063012.nc",
        "nrows": 82,
        "ncols": 67,
        "half_cell": 4500
    },
    27: {
        "CONC": "CONC.27KM.2025063012.nc",
        "GRIDCRO": "GRIDCRO2D_27KM.2025063012.nc",
        "METDOT": "METDOT3D_27KM.2025063012.nc",
        "nrows": 128,
        "ncols": 174,
        "half_cell": 13500
    },
...
def get_marker_test_lcc_layer_data(grid_km, layer, tstep, bg_poll, arrow_gap):
    try:
        ...
        conc_path = os.path.join(SCRIPT_DIR, 'data', cfg["CONC"])
